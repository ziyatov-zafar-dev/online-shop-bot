...
public class EmailServiceImpl implements EmailService {
    ...
    private static final String SHOP_COLOR_PRIMARY = "#FF6B35";    // Asosiy to'q sariq/orange
    private static final String SHOP_COLOR_SECONDARY = "#2E86AB";  // Havo ko'k
    private static final String SHOP_COLOR_SUCCESS = "#4CAF50";    // Yashil
    private static final String SHOP_COLOR_LIGHT = "#F8F9FA";      // Ochiq fon
    private static final String SHOP_COLOR_DARK = "#2D3047";       // Qorong'i ko'k
    ...
    public void send(String email, String code, String title, Purpose purpose) {
        ...
        try {
            ...
            // JSON ni to'g'ri formatda yaratish
    ...
    private String resolveSubject(String title, Purpose purpose) {
        ...
        return switch (purpose) {
            case SIGN_IN -> "SH-Z MARKET - Tizimga kirish kodi";
            case SIGN_UP -> "SH-Z MARKET - Ro'yxatdan o'tish kodi";
            case FORGOT_PASSWORD -> "SH-Z MARKET - Parolni tiklash kodi";
            case CHANGE_PASSWORD -> "SH-Z MARKET - Parol o'zgartirildi";
        };
    }
        ...
        return """
            ...
            <body>
                <div class="email-container">
                    ...
                    <!-- Footer qismi -->
                    <div class="footer">
                        <div class="shop-name">SH-Z MARKET</div>
                        ...
                        <div class="copyright">
                            © 2024 SH-Z MARKET. Barcha huquqlar himoyalangan.
                        </div>
                    </div>
                </div>
            </body>
    ...
    private String getMessageByPurpose(Purpose purpose) {
        return switch (purpose) {
            case SIGN_IN -> "SH-Z MARKET tizimiga kirish uchun quyidagi tasdiqlash kodidan foydalaning. Bu kod sizning hisobingizni himoya qilish uchun zarur.";
            case SIGN_UP -> "SH-Z MARKET da ro'yxatdan o'tishni yakunlash uchun quyidagi tasdiqlash kodidan foydalaning. Bizning jamoamizga xush kelibsiz!";
            case FORGOT_PASSWORD -> "Parolingizni tiklash uchun quyidagi koddan foydalaning. Yangi parol o'rnatgach, xavfsizlik uchun uni hech kimga bermang.";
            case CHANGE_PASSWORD -> "Parolingiz muvaffaqiyatli o'zgartirildi. Agar bu amaliyotni siz amalga oshirmagan bo'lsangiz, darhol biz bilan bog'laning.";
        };
    }
...
//    @Override
    public void sendWelcomeEmail(String email, String username) {
        try {
            String subject = "SH-Z MARKET ga xush kelibsiz! 🎉";
        ...
        return """
            ...
            <body>
                <div class="container">
                    ...
                    <p>SH-Z MARKET jamoasiga qo'shilganingiz bilan tabriklaymiz!</p>
                    <div class="benefits">
